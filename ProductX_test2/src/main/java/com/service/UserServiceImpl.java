...
import com.exception.NoSuchSellerExists;
...
public class UserServiceImpl implements UserServiceInterface {
	...
	public Product getOneProduct(int id) {
		return productRepo.findById(id).orElseThrow(() -> new NoSuchProductExist("Product does not exist with id: " + id));
	}
	...
	@Override
	public Product uploadphoto(MultipartFile photo) {
		// TODO Auto-generated method stub
		return productRepo.photoupload(photo);
	}
